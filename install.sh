...
PLAYTIME_EJS_REVISION=${PLAYTIME_EJS_REVISION:-"31d57343a8ef217a8f2773aba397fd929e4913ed"}
PLAYTIME_EJS_CORES_URL=${PLAYTIME_EJS_CORES_URL:-"https://local.doublebyte.ru/static/cores_2024_03_09_15_07_27.zip"}
PLAYTIME_EJS_CORES_DIR=${PLAYTIME_EJS_CORES_DIR:-"."}
